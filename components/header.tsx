...
//Notes:
// the change of header focus on to elements while scrolling is implemented by intersection observer Api, a browser know when it reaches an element. 
// react-intersection-observer used here
// clsx: conditionally apply given class name